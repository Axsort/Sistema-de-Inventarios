...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<Page<ProductResponse>>> findAll(
        ...
        return ResponseEntity.ok(
            ApiResponse.success(productService.findAll(search, categoryId, active, page, size)));
    }
    ...
    public ResponseEntity<ApiResponse<ProductResponse>> create(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success("Producto creado", productService.create(request)));
    }
    ...
    public ResponseEntity<ApiResponse<ProductResponse>> update(
            ...
            @Valid @RequestBody ProductRequest request) {
        return ResponseEntity.ok(
            ApiResponse.success("Producto actualizado", productService.update(id, request)));
    }
